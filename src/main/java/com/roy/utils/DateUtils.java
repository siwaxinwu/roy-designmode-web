 ...
 * @author dingyawu
 * @version 1.0
 * @date created in 14:45 2021-03-19
 */
public class DateUtils {
  ...
  // -----------------------------------------------------------------------
  /**
   * Constructs an <code>Iterator</code> over each day in a date range defined by a focus date and
   * range style.
   *
   * <p>For instance, passing Thursday, July 4, 2002 and a <code>RANGE_MONTH_SUNDAY</code> will
   * return an <code>Iterator</code> that starts with Sunday, June 30, 2002 and ends with Saturday,
   * August 3, 2002, returning a Calendar instance for each intermediate day.
   *
